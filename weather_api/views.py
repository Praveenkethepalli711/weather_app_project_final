    ...
    if request.method == "POST":
        ...
        try:
            context = {
                ...
                "feels_like":math.ceil(w_dataset["list"][0]["main"]["feels_like"] -273.0),
                "Max_temp":math.ceil(w_dataset["list"][0]["main"]["temp_max"] -273.0),
                "Min_temp":math.floor(w_dataset["list"][1]["main"]["temp_min"] - 273.0),
